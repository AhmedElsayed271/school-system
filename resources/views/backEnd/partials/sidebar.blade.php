        ...
        <ul class="list-unstyled components" id="sidebar_menu">
            ...
            @if (Auth::user()->role_id != 2 && Auth::user()->role_id != 3)
                @if (userPermission(1))
                    <li>
                        @if (moduleStatusCheck('Saas') == true && Auth::user()->is_administrator == 'yes' && Session::get('isSchoolAdmin') == false && Auth::user()->role_id == 1)
                            <a href="{{ route('find.result') }}" id="superadmin-dashboard">
                                @else
                                    <a href="{{ route('find.result') }}" id="admin-dashboard">
                                        @endif
                                        <div class="nav_icon_small">
                                            <span class="flaticon-speedometer"></span>
                                        </div>
            ...
            @else
                ...
                @if (Auth::user()->role_id != 2 && Auth::user()->role_id != 3)
                    ...
                    @if (userPermission(61) && menuStatus(61) && isMenuAllowToShow('student_info'))
                        <li data-position="{{ menuPosition(61) }}" class="sortable_li">
                            ...
                            <ul class="list-unstyled" id="subMenuStudent">
                                ...
                                @endif
                                @if (userPermission(15201) && menuStatus(15201))
                                    <li data-position="{{ menuPosition(15201) }}">
                                        <a href="{{ route('student.multi-class-student') }}"> @lang('student.multi_class_student')</a>
                                    </li>
                                @endif
                                @if (userPermission(15205) && menuStatus(15205))
                                    <li data-position="{{ menuPosition(15205) }}">
                                        <a href="{{ route('student.delete-student-record') }}"> @lang('student.deleted_student_record')</a>
                                    </li>
                                @endif
                                ...
                                @if ((userPermission(436) && menuStatus(436)) || (userPermission(706) && menuStatus(706)))
                                    ...
                                    <li>
                                        ...
                                        <ul class="list-unstyled {{ spn_nav_item_open($subMenuExam, 'show') }}"
                                            ...
                                            <li>
                                                <a href="{{ route('all-exam-report-position') }}">@lang('exam.all_exam_position')</a>
                                            </li>
                                        </ul>
                                    </li>
                                @endif
                    ...
                    @if (moduleStatusCheck('ExamPlan') && isMenuAllowToShow('examplan'))
                    ...
                    {{-- HomeWork --}}
                    @if (userPermission(277) && menuStatus(277) && isMenuAllowToShow('homework'))
                            ...
                            <ul class="list-unstyled" id="subMenusystemReports">
                                ...
                                @if (!moduleStatusCheck('University'))
                                    ...
                                    @if (userPermission(392) && menuStatus(392))
                                        ...
                                        <li>
                                            <a href="{{ route('custom_progress_card_report_percent') }}">@lang('reports.progress_card_report_100_percent')</a>
                                        </li>
                                    @endif
                                @endif
