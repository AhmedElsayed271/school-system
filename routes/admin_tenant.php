...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('dashboard/find-result', 'showResultController@findResult')->name('find.result');
        Route::post('dashboard/show-result', 'showResultController@showResult')->name('show.result');
        Route::post('dashboard/export-pdf', 'showResultController@exportToPdf')->name('export.pdf');
        ...
        Route::get('create-currency', 'Admin\GeneralSettings\SmManageCurrencyController@create')->name('create-currency')->middleware('userRolePermission:401');
        ...
        Route::get('manage-currency/active/{id}', 'Admin\GeneralSettings\SmManageCurrencyController@manageCurrencyActive')->name('currency_active')->middleware('userRolePermission:404');
    ...
    //color theme change
    Route::get('color-style', 'Admin\Style\ThemeController@index')->name('color-style')->middleware('userRolePermission:490');
    ...
    Route::get('theme-create', 'Admin\Style\ThemeController@create')->name('theme-create');
    Route::post('theme-create-store', 'Admin\Style\ThemeController@store')->name('theme-store');
    Route::get('theme-create', 'Admin\Style\ThemeController@create')->name('theme-create');
    Route::post('theme-create-store', 'Admin\Style\ThemeController@store')->name('theme-store');

    Route::get('themes/{theme}/copy', 'Admin\Style\ThemeController@copy')->name('themes.copy');
    Route::get('themes/{theme}/default', 'Admin\Style\ThemeController@default')->name('themes.default');
    ...
    // Unassigned Student
    Route::get('unassigned-student', ['as' => 'unassigned_student', 'uses' => 'SmStudentAdmissionController@unassignedStudent'])->middleware('userRolePermission:15209');
    ...
    Route::get('multi-class-student', 'Admin\StudentInfo\StudentMultiRecordController@multiRecord')->name('student.multi-class-student')->middleware('userRolePermission:15201');
    ...
    ->name('student.delete-student-record')->middleware('userRolePermission:15205');
    ...
    ->middleware('userRolePermission:100');
